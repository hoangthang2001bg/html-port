<?php
    ...
    include ('control.php');
    $getdata=new data();
    $userList=$getdata->register_id($id);
?>
<!DOCTYPE php>
<php lang="en">
<head>
        ...
        <div class="banner">
            <div class="inner">
                <div class="container text-center">
                    <p class="title-heading">THÔNG TIN TÀI KHOẢN</p>
                    <p class="intro"><a href="">Trang chủ</a>/ <a href="">Thông tin tài khoản</a></p>
                </div>
            </div>
        </div>
        <div class="checkout">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
                        <p class="transport">
                            <p class="tran-heading">Thông tin tài khoản</p>
                                <p style="font-style: italic;"> Xin chào: <?php require_once("hienthiuser/fullnameuser.php");?></p>
                            <div class="row">
                                <tr>
                                    <div class="col-7">
                                    <td>Địa Chỉ: <?php require_once("hienthiuser/dob.php");?></td>
                                    </div>
                                    <hr class="dashed">
                                    <div class="col-7">
                                    <td>Email: <?php require_once("hienthiuser/emailuser.php");?></td>
                                    </div>
                                    <hr class="dashed">
                                    <div class="col-7">
                                    <td><?php require_once("backend/loginadmin.php");?></td>
                                    </div>
                                    <hr class="dashed">
                                    <div class="col-7">
                                    <td><a href="backend/logoutCookie.php">Đăng Xuất</a></td>
                                    </div>
                                </tr>
                            </div>
                        </p>
