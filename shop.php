<?php
      ...
      $select_product=$getdata->select_all(); //gọi hàm hiện thị dữ liệu
      ...
      $select_fashion_limit=$getdata->se_product_limit($start_page,$num_of_page);
                ...
                <div class="row">
                                    ...
                                    <div class="accordion-item">
                                      ...
                                      <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul class="navbar-nav">
                                                <li class="nav-item"> <a style="color:black;font-size:17px;padding:2px;font-weight: normal;" class="nav-link active" href="ban.php">Bàn</a></li>
                                                <li class="nav-item"> <a style="color:black;font-size:17px;padding:2px;font-weight: normal;" class="nav-link active" href="">Ghế</a></li>
                                                <li class="nav-item"> <a style="color:black;font-size:17px;padding:2px;font-weight: normal;" class="nav-link active" href="">Sofa</a></li>
                                            </ul>
                                        </div>
                                      </div>
                                    </div>
                    ...
                    <div class="col-lg-9 col-12">
                        ...
                        <div class="pagination justify-content-center d-flex">
                            ...
                            echo '<a href="shop.php?page='.($page-1).'"class="btn btn-prev align-items-center d-flex"><i class="fas fa-angle-double-left"></i></a>';}
                            ?>
                            <?php
                            for($i=1;$i<=$total_page;$i++) {    ?>
                                <?php if($i != $page){?>
                                    <div><a class="btn btn-number" href="shop.php?page=<?php echo $i ?>"><?php echo $i ?></a></div>
                            ...
                            echo '<a href="shop.php?page='.($page+1).'" class="btn btn-next align-items-center d-flex"><i class="fas fa-angle-double-right"></i></a>';}
                            ?>
                        </div>
                    </div>
                </div>
