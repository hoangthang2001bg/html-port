<?php
      ...
      $select_product=$getdata->se_category('ghe'); //gọi hàm hiện thị dữ liệu
      ...
      $select_fashion_limit=$getdata->se_category_limit($start_page,$num_of_page,'ghe');
                ...
                <div class="row">
                                      ...
                                      <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul class="navbar-nav">
                                                ...
                                                <li class="nav-item"> <a style="color:#c89551 !important;font-size:17px;padding:2px;font-weight: normal;" class="nav-link active" href="ghe.php">Ghế</a></li>
                    ...
                    <div class="col-lg-9 col-12">
                        ...
                        <div class="pagination justify-content-center d-flex">
                            ...
                            echo '<a href="ghe.php?page='.($page-1).'"class="btn btn-prev align-items-center d-flex"><i class="fas fa-angle-double-left"></i></a>';}
                            ?>
                            <?php
                            for($i=1;$i<=$total_page;$i++) {    ?>
                                <?php if($i != $page){?>
                                    <div><a class="btn btn-number" href="ghe.php?page=<?php echo $i ?>"><?php echo $i ?></a></div>
                            ...
                            echo '<a href="ghe.php?page='.($page+1).'" class="btn btn-next align-items-center d-flex"><i class="fas fa-angle-double-right"></i></a>';}
                            ?>
                        </div>
                    </div>
                </div>
