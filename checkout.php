                ...
                <div class="row">
                    <div class="col-lg-7">
                        <p class="transport">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <input type="name" readonly value="<?php echo $infoUser['fullname'] ?>">
                                </div>
                                <div class="col-5">
                                    <input type="number" readonly value="<?php echo $infoUser['phone'] ?>">
                                </div>
                            </div>
                            <input type="email" readonly value="<?php echo $infoUser['email'] ?>">
                            <input type="text"
                            readonly value="<?php echo $infoUser['address'] ?>">
                        ...
                        <div class="payment">
                            ...
                            <div class="live d-flex align-items-center">
                                <input type="radio" class="radio1" name="ok">
                                <i class="fas fa-truck"></i>
                                <p>THANH TOÁN TRỰC TIẾP KHI NHẬN HÀNG</p>
                            </div>
                            <div class="oline d-flex align-items-center">
                                <input type="radio" class="radio1" name="ok">
                    ...
                    <div class="col-lg-5">
                        ...
                        <?php
                              ...
                              foreach($cartList as $cart){
                                $shoe = $getdata->se_detail($cart['sp_id'])->fetch_assoc();
                            ?>
                            <?php
                            $price = $shoe['gia_sp'];
                            $sale = $shoe['sale_sp'];
                            ...
                            $tamtinh= $discount * $cart['sp_sl'];
                            ?>
                            <div class="order-info">
                                            <div class="row align-items-center">
                                                <div class="col-3"><img src="bs-advance-admin\advance-admin\images\<?php echo $shoe['anh_sp'];?>" alt=""></div>
                                                <div class="col-9"><?php echo $shoe['ten_sp'];?></div>
                                            </div>
                                        </div>
                                        <div class="price">
                                            <div class="row">
                                                <div class="col-4">Giá:</div>
                                                <div class="col-8 text-end"><?php echo currency_format($shoe['gia_sp']);?></div>
                                            </div>
                                        </div>
                                        <div class="soluong">
                                            <div class="row">
                                                <div class="col-4">Số lượng:</div>
                                                <div class="col-8 text-end"><?php echo $cart['sp_sl'];?></div>
                                            </div>
                                        </div>
                                        <div class="discount">
                                            <div class="row">
                                                <div class="col-4">Khuyến mại:</div>
                                                <div class="col-8 text-end"><?php echo $shoe['sale_sp'];?>%</div>
                                            </div>
                                        </div>    
                                        <div class="tamtinh">
                                            <div class="row">
                                                <div class="col-4">Tạm tính:</div>
                                                <div class="col-8 text-end order-price"><?php echo currency_format($tamtinh); ?></div>
                                            </div>
                                        </div>
                            <?php
                              }
                            ...
                            <div class="total">
                                <div class="row">
                                    ...
                                    <div class="col-8 text-end tongtatca">2000.000</div>
                                </div>
                            </div>
                            <div class="text-center">
                                <button class="btn" name="submit_oder">Đặt hàng</button>
                            </div>
                            <?php
                            if(isset($_POST['submit_oder'])){
                              foreach($cartList as $cart){
                                $shoe = $getdata->se_detail($cart['sp_id'])->fetch_assoc();
                                $orderRepository->insert($cart['id']);
                                $cartRepository->updateStatusByUserIdAndShoeId($infoUser['id'],$cart['sp_id'],2);
                              }
